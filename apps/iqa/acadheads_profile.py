...
def record_acadhead_profile(submitbtn, closebtn, removerecord,
                            ...
                            unithead_cluster_id, unithead_college_id, unithead_deg_unit_id, search):
            ...
            if create_mode == 'add':
                ...
                sql = """
                    INSERT INTO iqateam.acad_unitheads (
                        ...
                        unithead_college_id, unithead_deg_unit_id, unithead_del_ind
                    )
                    VALUES (%s, %s, %s, %s,
                            %s, %s, %s, %s,
                            %s, %s, %s, %s, %s)
                ...
                values = (unithead_fname, unithead_mname, 
                        ...
                        unithead_appointment_start, unithead_appointment_end, 
                        unithead_cluster_id, unithead_college_id, unithead_deg_unit_id, False
                )
